...
import { getUseCasePage, getAllUseCaseSlugs } from "@/lib/seo-content";
...
export async function generateMetadata({
  ...
  const page = await getUseCasePage(slug);
  if (!page) return {};
  ...
  return (
    <>
      ...
      <BehaviorTracker
        ...
        properties={{ slug, title: page.headline, type: "use-case" }}
      />
    </>
  );
}
