...
function buildItineraryHtml(
  ...
  return `
    <div style="max-width: 600px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; color: #171717; line-height: 1.6;">
      ...
      <p style="font-size: 15px; color: #525252;">Here's your Colorado trip itinerary — built by the team behind 200+ vacation rentals across Crested Butte, Leadville, and the Colorado mountains.</p>
