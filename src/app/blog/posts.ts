...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: "Leadville sits at 10,152 feet — higher than most Colorado summits — and the trails that fan out from town are some of the most rewarding in the Rockies. Here's your local guide to the best hikes near Leadville, from gentle lakeside loops to the rooftop of the lower 48.",
    date: "2026-05-18",
