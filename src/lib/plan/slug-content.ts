...
export const AUTHOR_BYLINE =
  "Written by the Traverse Hospitality team — locals managing 200+ vacation rentals across Colorado's Crested Butte, Leadville, Vail, Avon, Granby, and Twin Lakes markets. We've hosted thousands of guests and built these itineraries from the places we recommend to friends, family, and our own booked guests.";
