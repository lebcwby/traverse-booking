...
export function getOrganizationSchema(aggregateRating?: {
  ...
  return {
    ...
    description:
      "Colorado's local vacation rental company. 200+ homes across Crested Butte, Leadville, Vail, Avon, Granby, and Twin Lakes — pet-friendly, luxury, family, and extended stays. No booking fees.",
    address: {
      "@type": "PostalAddress",
