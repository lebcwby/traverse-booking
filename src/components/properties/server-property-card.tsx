 ...
 * Outputs crawlable HTML in the initial response (no "use client").
 * Use on landing pages (/s/[slug]) and other SEO-critical listing pages.
 */
    ...
    <Link href={href} className="group block">
      ...
      <div className="relative aspect-square overflow-hidden rounded-xl bg-muted">
        ...
        {listing.reviewAvg && listing.reviewAvg / 2 >= 4.8 && (
          <span className="absolute left-3 top-3 z-10 flex items-center gap-1.5 rounded-full bg-white py-1.5 pl-2.5 pr-3 text-xs font-semibold text-[#1c1d1d] shadow-md">
